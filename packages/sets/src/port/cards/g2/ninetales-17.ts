...
export class Ninetales_17 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      ...
      { name: "Fire Blast", cost: [], damage: "80", text: "Discard 1 Fire Energy card attached to Ninetales or this attack does nothing." }
  ];
  public set: string = "G2";
  public name: string = "Ninetales";
  public fullName: string = "Ninetales G2 17";
