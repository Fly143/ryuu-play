...
export class Weedle_93 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      ...
      { name: "String Shot", cost: [], damage: "", text: "Flip a coin. If heads, the Defending Pokémon is now Paralyzed." }
  ];
  public set: string = "GE";
  public name: string = "Weedle";
  public fullName: string = "Weedle GE 93";
