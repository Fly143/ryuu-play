...
export class Swoobat_71 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Jet Woofer", cost: [], damage: "", text: "For each Psychic Energy attached to this Pokémon, discard the top card of your opponent's deck." },
  ...
  public fullName: string = "Swoobat PLS 71";
