...
export class HeatranSM96 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      ...
      { name: "Boiling Impact", cost: [], damage: "130", text: "Discard 2 Energy from this Pokémon." }
  ];
  public set: string = "PR-SM";
  public name: string = "Heatran";
  public fullName: string = "Heatran PR-SM SM96";
