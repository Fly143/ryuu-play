...
export class UnownX extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Hidden Power", cost: [], damage: "20×", text: "Flip a coin until you get tails. This attack does 20 damage times the number of heads." }
  ];
  public set: string = "UF";
  public name: string = "Unown";
  public fullName: string = "Unown UF X";
