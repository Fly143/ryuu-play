...
export class Murkrow_21 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Spin Turn", cost: [], damage: "10", text: "Switch this Pokémon with 1 of your Benched Pokémon." },
  ...
  public fullName: string = "Murkrow PR-SV 21";
