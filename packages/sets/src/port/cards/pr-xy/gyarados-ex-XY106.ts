...
export class GyaradosEXXY106 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Stormy Seas", cost: [], damage: "", text: "Flips a coin until you get tails. For each heads, search your deck for a Water Energy card and attach it to this Pokémon. Shuffle your deck afterward." },
  ...
  public fullName: string = "Gyarados-EX PR-XY XY106";
