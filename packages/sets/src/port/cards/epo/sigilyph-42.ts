...
export class Sigilyph_42 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      ...
      { name: "Psychic Assault", cost: [], damage: "40+", text: "Does 10 more damage for each damage counter on the Defending Pokémon." }
  ];
