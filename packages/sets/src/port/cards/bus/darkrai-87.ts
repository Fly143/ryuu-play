...
export class Darkrai_87 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      ...
      { name: "Dark Raid", cost: [], damage: "80+", text: "If your opponent has already used their GX attack, this attack does 80 more damage." }
  ];
