...
export class AlolanRattata_81 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Focus Energy", cost: [], damage: "", text: "During your next turn, this Pokémon's Bite attack's base damage is 60." },
