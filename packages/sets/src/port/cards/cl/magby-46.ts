...
export class Magby_46 extends PokemonCard {
  ...
  public powers: Power[] = [
      { name: "Sweet Sleeping Face", powerType: PowerType.ABILITY, text: "As long as Magby is Asleep, prevent all damage done to Magby by attacks.", useWhenInPlay: true }
  ];
  ...
  public fullName: string = "Magby CL 46";
