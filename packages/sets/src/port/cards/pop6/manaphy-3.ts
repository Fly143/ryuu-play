...
export class Manaphy_32 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      ...
      { name: "Aqua Ring", cost: [], damage: "30", text: "Switch Manaphy with 1 of your Benched Pokémon." }
  ];
  public set: string = "POP6";
  public name: string = "Manaphy";
  public fullName: string = "Manaphy POP6 3";
