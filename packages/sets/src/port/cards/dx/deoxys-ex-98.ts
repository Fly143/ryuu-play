...
export class DeoxysEx_98 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Psyburst", cost: [], damage: "50+", text: "You may discard 2 Energy attached to Deoxys ex. If you do, this attack does 50 damage plus 20 more damage for each Energy attached to the Defending Pokémon." }
  ];
  public set: string = "DX";
  public name: string = "Deoxys ex";
  public fullName: string = "Deoxys ex DX 98";
