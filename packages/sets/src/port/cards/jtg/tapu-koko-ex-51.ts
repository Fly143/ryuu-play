...
export class TapuKokoEx_51 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Linked Lightning", cost: [], damage: "60+", text: "This attack does 20 more damage for each of your Benched Pokémon." }
  ];
