...
export class DuraludonV_47 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Gatling Slug", cost: [], damage: "10+", text: "This attack does 40 more damage for each Metal Energy attached to this Pokémon." }
  ];
