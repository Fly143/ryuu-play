...
export class Talonflame_29 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      ...
      { name: "Merciless Strike", cost: [], damage: "80+", text: "If your opponent's Active Pokémon already has any damage counters on it, this attack does 80 more damage." }
  ];
  public set: string = "PGO";
  public name: string = "Talonflame";
  public fullName: string = "Talonflame PGO 29";
