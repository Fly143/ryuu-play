...
export class JirachiXY112 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      ...
      { name: "Iron Head", cost: [], damage: "", text: "Flip a coin until you get tails. This attack does 30 damage times the number of heads." }
  ];
  public set: string = "PR-XY";
  public name: string = "Jirachi";
  public fullName: string = "Jirachi PR-XY XY112";
