...
export class DarkGolbat_24 extends PokemonCard {
  ...
  public fullName: string = "Dark Golbat TR 24";
  ...
  public reduceEffect(store: StoreLike, state: State, effect: Effect): State {
    ...
    if (effect instanceof PowerEffect && effect.power === this.powers[0]) {
      return commonEffects.runPowerOp(this, store, state, effect).reduce(effect.power, "damageOneBench:10");
    }
    return state;
  }
}
