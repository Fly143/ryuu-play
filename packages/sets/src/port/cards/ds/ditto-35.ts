...
export class Ditto_35 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Energy Link", cost: [], damage: "10", text: "Search your discard pile for an Energy card and attach it to Ditto." }
  ];
  public set: string = "DS";
  public name: string = "Ditto";
  public fullName: string = "Ditto DS 35";
