...
export class Goldeen_107 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Flail", cost: [], damage: "10×", text: "Does 10 damage times the number of damage counters on Goldeen." },
  ...
  public fullName: string = "Goldeen SV 107";
