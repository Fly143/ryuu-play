...
export class UnownJ extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Hidden Power", cost: [], damage: "", text: "Flip a coin. If heads, switch all damage counters on Unown with those on the Defending Pokémon. (If an effect of this attack is prevented, this attack does nothing.)" }
  ];
  public set: string = "UF";
  public name: string = "Unown";
  public fullName: string = "Unown UF J";
