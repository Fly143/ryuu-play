...
export class KingdraXY39 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      ...
      { name: "Dragon Blast", cost: [], damage: "150", text: "Discard a Water and a Lightning Energy attached to this Pokémon." }
  ];
  public set: string = "PR-XY";
  public name: string = "Kingdra";
  public fullName: string = "Kingdra PR-XY XY39";
