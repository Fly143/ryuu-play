...
export class Latios_108 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Dragon Fleet", cost: [], damage: "50×", text: "This attack does 50 damage for each of your Evolution Dragon Pokémon in play." }
  ];
