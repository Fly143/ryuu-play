...
export class Beldum_1 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      ...
      { name: "Metal Ball", cost: [], damage: "", text: "Put 1 damage counter on the Defending Pokémon." }
  ];
  public set: string = "TK2A";
  public name: string = "Beldum";
  public fullName: string = "Beldum TK2A 1";
