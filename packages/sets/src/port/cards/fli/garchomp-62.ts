...
export class Garchomp_62 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      ...
      { name: "Royal Blades", cost: [], damage: "100+", text: "If you played Cynthia from your hand during this turn, this attack does 100 more damage." }
  ];
  public set: string = "FLI";
  public name: string = "Garchomp";
  public fullName: string = "Garchomp FLI 62";
