...
export class Vanillish_34 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Triple Spin", cost: [], damage: "20×", text: "Flip 3 coins. This attack does 20 damage times the number of heads." },
      { name: "Frost Breath", cost: [], damage: "50", text: "" }
  ];
  public set: string = "DRX";
  public name: string = "Vanillish";
  public fullName: string = "Vanillish DRX 34";
