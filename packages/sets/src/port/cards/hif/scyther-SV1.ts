...
export class ScytherSV1 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Twin Play", cost: [], damage: "", text: "Search your deck for up to 2 Scyther and put them onto your Bench. Then, shuffle your deck." },
