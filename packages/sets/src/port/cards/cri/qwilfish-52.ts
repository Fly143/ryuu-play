...
export class Qwilfish_52 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Venoshock", cost: [], damage: "30+", text: "If your opponent's Active Pokémon is Poisoned, this attack does 50 more damage." }
  ];
  public set: string = "CRI";
  public name: string = "Qwilfish";
  public fullName: string = "Qwilfish CRI 52";
