...
export class Ditto_61 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Fireworks", cost: [], damage: "30", text: "Flip a coin. If tails, discard a Fire Energy card attached to Ditto." }
  ];
  public set: string = "DS";
  public name: string = "Ditto";
  public fullName: string = "Ditto DS 61";
