...
export class Combusken_39 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      ...
      { name: "Super Singe", cost: [], damage: "40", text: "Flip a coin. If heads, the Defending Pokémon is now Burned." }
  ];
  public set: string = "HP";
  public name: string = "Combusken";
  public fullName: string = "Combusken HP 39";
