...
export class Seviper_128 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      ...
      { name: "Venoshock", cost: [], damage: "60+", text: "If your opponent's Active Pokémon is Poisoned, this attack does 120 more damage." }
  ];
