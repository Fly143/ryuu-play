...
export class Amoonguss_10 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Toxic", cost: [], damage: "", text: "The Defending Pokémon is now Poisoned. Put 2 damage counters instead of 1 on that Pokémon between turns." },
