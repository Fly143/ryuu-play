...
export class Electivire_59 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      ...
      { name: "Electrified Bolt", cost: [], damage: "90+", text: "If this Pokémon has any Special Energy attached, this attack does 90 more damage." }
  ];
