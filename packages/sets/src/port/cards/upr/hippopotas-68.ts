...
export class Hippopotas_68 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Eleventh Hour Tackle", cost: [], damage: "50+", text: "If there are 3 or fewer cards in your deck, this attack does 130 more damage." }
  ];
