...
export class Nosepass_17 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      ...
      { name: "Wide Laser", cost: [], damage: "", text: "Does 10 damage to each of your opponent's Pokémon. (Don't apply Weakness and Resistance for Benched Pokémon.)" }
  ];
  public set: string = "EM";
  public name: string = "Nosepass";
  public fullName: string = "Nosepass EM 17";
