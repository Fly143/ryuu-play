...
export class Exeggcute_33 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Psybeam", cost: [], damage: "10", text: "Flip a coin. If heads, the Defending Pokémon is now Confused." },
  ...
  public fullName: string = "Exeggcute RG 33";
