...
export class Wooloo_221 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Derail", cost: [], damage: "10", text: "Discard a Special Energy from your opponent's Active Pokémon." },
  ...
  public fullName: string = "Wooloo EVS 221";
