...
export class UnownN extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Hidden Power", cost: [], damage: "", text: "Remove 5 damage counters from Unown. (All if there are less than 5.)" }
  ];
  public set: string = "UF";
  public name: string = "Unown";
  public fullName: string = "Unown UF N";
