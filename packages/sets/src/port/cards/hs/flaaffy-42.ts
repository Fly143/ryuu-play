...
export class Flaaffy_42 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      ...
      { name: "Thundershock", cost: [], damage: "40", text: "Flip a coin. If heads, the Defending Pokémon is now Paralyzed." }
  ];
  public set: string = "HS";
  public name: string = "Flaaffy";
  public fullName: string = "Flaaffy HS 42";
