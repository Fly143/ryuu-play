...
export class FlyingPikachuV_6 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      ...
      { name: "Fly", cost: [], damage: "120", text: "Flip a coin. If tails, this attack does nothing. If heads, during your opponent's next turn, prevent all damage from and effects of attacks done to this Pokémon." }
  ];
  public set: string = "CEL";
  public name: string = "Flying Pikachu V";
  public fullName: string = "Flying Pikachu V CEL 6";
  public text: string = "Flying Pikachu V";
