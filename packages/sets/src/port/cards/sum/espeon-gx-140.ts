...
export class EspeonGX_140 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      ...
      { name: "Psychic", cost: [], damage: "60+", text: "This attack does 30 more damage times the amount of Energy attached to your opponent's Active Pokémon." },
