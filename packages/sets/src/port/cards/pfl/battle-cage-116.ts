...
export class BattleCage_116 extends TrainerCard {
  public trainerType: TrainerType = TrainerType.STADIUM;
  public set: string = "PFL";
  public name: string = "Battle Cage";
  public fullName: string = "Battle Cage PFL 116";
  ...
  public reduceEffect(store: StoreLike, state: State, effect: Effect): State {
    if (effect instanceof TrainerEffect && effect.trainerCard === this) {
      return commonEffects.runTrainerOp(this, store, state, effect).playCard(effect as TrainerEffect, "auraProtectBench");
    }
    return state;
  }
}
