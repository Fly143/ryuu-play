...
export class MeloettaBW69 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      ...
      { name: "Acrobatics", cost: [], damage: "40+", text: "Flip 2 coins. This attack does 20 more damage for each heads." }
  ];
  public set: string = "PR-BLW";
  public name: string = "Meloetta";
  public fullName: string = "Meloetta PR-BLW BW69";
