...
export class Lombre_33 extends PokemonCard {
  ...
  public powers: Power[] = [
      { name: "Aqua Lift", powerType: PowerType.ABILITY, text: "If Lombre has any Water Energy attached to it, the Retreat Cost for Lombre is 0.", useWhenInPlay: true }
  ];
