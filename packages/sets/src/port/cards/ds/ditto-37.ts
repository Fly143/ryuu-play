...
export class Ditto_37 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Rage", cost: [], damage: "10+", text: "Does 10 damage plus 10 more damage for each damage counter on Ditto." }
  ];
  public set: string = "DS";
  public name: string = "Ditto";
  public fullName: string = "Ditto DS 37";
