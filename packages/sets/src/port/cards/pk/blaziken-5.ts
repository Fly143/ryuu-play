...
export class Blaziken_5 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Fire Stream", cost: [], damage: "50", text: "Discard a Fire Energy card attached to Blaziken. This attack does 10 damage to each of your opponent's Benched Pokémon. (Don't apply Weakness and Resistance for Benched Pokémon.)" }
  ];
  public set: string = "PK";
  public name: string = "Blaziken";
  public fullName: string = "Blaziken PK 5";
