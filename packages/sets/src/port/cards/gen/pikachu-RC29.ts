...
export class PikachuRC29 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      ...
      { name: "Quick Attack", cost: [], damage: "20+", text: "Flip a coin. If heads, this attack does 10 more damage." }
  ];
  public set: string = "GEN";
  public name: string = "Pikachu";
  public fullName: string = "Pikachu GEN RC29";
