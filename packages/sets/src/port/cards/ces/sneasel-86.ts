...
export class Sneasel_86 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      ...
      { name: "Beat Up", cost: [], damage: "30×", text: "Flip a coin for each Pokémon you have in play. This attack does 30 damage for each heads." }
  ];
