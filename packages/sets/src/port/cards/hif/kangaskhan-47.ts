...
export class Kangaskhan_47 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Parental Fury", cost: [], damage: "40×", text: "Flip a coin until you get tails. This attack does 40 damage for each heads." }
  ];
