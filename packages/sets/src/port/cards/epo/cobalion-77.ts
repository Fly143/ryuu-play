...
export class Cobalion_77 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Metal Horns", cost: [], damage: "30", text: "Your opponent switches the Defending Pokémon with 1 of his or her Benched Pokémon." },
