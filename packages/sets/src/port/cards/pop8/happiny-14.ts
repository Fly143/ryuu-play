...
export class Happiny_14 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Lively", cost: [], damage: "", text: "Remove 2 damage counters from 1 of your Pokémon." }
  ];
  public set: string = "POP8";
  public name: string = "Happiny";
  public fullName: string = "Happiny POP8 14";
