...
export class Houndoom_14 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      ...
      { name: "Burn Up", cost: [], damage: "60", text: "Flip a coin. If tails, discard all Fire Energy cards attached to Houndoom." }
  ];
  public set: string = "AQ";
  public name: string = "Houndoom";
  public fullName: string = "Houndoom AQ 14";
