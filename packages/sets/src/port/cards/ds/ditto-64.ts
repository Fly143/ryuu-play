...
export class Ditto_64 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Spiral Drain", cost: [], damage: "20", text: "Remove 3 damage counters from Ditto (all if there are less than 3)." }
  ];
  public set: string = "DS";
  public name: string = "Ditto";
  public fullName: string = "Ditto DS 64";
