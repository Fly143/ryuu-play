...
export class Lapras_79 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Grind", cost: [], damage: "10×", text: "Does 10 damage times the amount of Energy attached to Lapras." },
  ...
  public fullName: string = "Lapras PL 79";
