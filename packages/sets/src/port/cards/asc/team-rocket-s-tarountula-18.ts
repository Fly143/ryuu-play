...
export class TeamRocketSTarountula_18 extends PokemonCard {
  ...
  public fullName: string = "Team Rocket's Tarountula ASC 18";
  public text: string = "Team Rocket's Tarountula";
