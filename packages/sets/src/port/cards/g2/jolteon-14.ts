...
export class Jolteon_14 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      ...
      { name: "Pin Missle", cost: [], damage: "20×", text: "Flip 4 coins. This attack does 20 damage times the number of heads." }
  ];
  public set: string = "G2";
  public name: string = "Jolteon";
  public fullName: string = "Jolteon G2 14";
