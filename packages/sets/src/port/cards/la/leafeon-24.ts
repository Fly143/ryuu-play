...
export class Leafeon_24 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Sprial Drain", cost: [], damage: "40", text: "Remove 1 damage counter from Leafeon." },
  ...
  public fullName: string = "Leafeon LA 24";
