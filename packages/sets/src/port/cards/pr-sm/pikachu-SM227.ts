...
export class PikachuSM227 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      ...
      { name: "Thunderbolt", cost: [], damage: "80", text: "Discard all Energy from this Pokémon." }
  ];
  public set: string = "PR-SM";
  public name: string = "Pikachu";
  public fullName: string = "Pikachu PR-SM SM227";
