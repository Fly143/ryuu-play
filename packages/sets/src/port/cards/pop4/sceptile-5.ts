...
export class Sceptile_5 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Tail Rap", cost: [], damage: "50×", text: "Flip 2 coins. This attack does 50 damage times the number of heads." }
  ];
  public set: string = "POP4";
  public name: string = "Sceptile";
  public fullName: string = "Sceptile POP4 5";
