...
export class Lairon_32 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Granite Head", cost: [], damage: "20", text: "During your opponent's next turn, any damage done to Lairon by attacks is reduced by 10 (after applying Weakness and Resistance)." },
  ...
  public fullName: string = "Lairon PK 32";
