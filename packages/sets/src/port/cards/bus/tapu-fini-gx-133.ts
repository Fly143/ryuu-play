...
export class TapuFiniGX_133 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      ...
      { name: "Hydro Shot", cost: [], damage: "", text: "Discard 2 Water Energy from this Pokémon. This attack does 120 damage to 1 of your opponent's Pokémon. (Don't apply Weakness or Resistance for Benched Pokémon.)" },
