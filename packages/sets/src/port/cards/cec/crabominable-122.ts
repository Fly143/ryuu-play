...
export class Crabominable_122 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Freezing Punch", cost: [], damage: "80+", text: "If this Pokémon has any Water Energy attached to it, this attack does 80 more damage." }
  ];
