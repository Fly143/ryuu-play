...
export class PikachuSM162 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      ...
      { name: "Thunder Jolt", cost: [], damage: "30", text: "This Pokémon does 10 damage to itself." }
  ];
  public set: string = "PR-SM";
  public name: string = "Pikachu";
  public fullName: string = "Pikachu PR-SM SM162";
