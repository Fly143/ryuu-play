...
export class AlolanDiglett_78 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Iron Head", cost: [], damage: "10×", text: "Flip a coin until you get tails. This attack does 10 damage for each heads." }
  ];
