...
export class Magby_58 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Ignite", cost: [], damage: "10", text: "If Full Flame is in play, the Defending Pokémon is now Burned." }
  ];
  public set: string = "LM";
  public name: string = "Magby";
  public fullName: string = "Magby LM 58";
