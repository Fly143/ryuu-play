...
export class UnownL extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Hidden Power", cost: [], damage: "", text: "Flip a coin. If heads, put damage counters on the Defending Pokémon until it is 10 HP away from being Knocked Out." }
  ];
  public set: string = "UF";
  public name: string = "Unown";
  public fullName: string = "Unown UF L";
