...
export class Raichu_36 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      ...
      { name: "Spark Bolt", cost: [], damage: "70+", text: "You may discard all Energy attached to this Pokémon. If you do, this attack does 70 more damage." }
  ];
