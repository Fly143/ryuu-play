...
export class TeamAquaSSealeo_4 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      ...
      { name: "Hail Storm", cost: [], damage: "60+", text: "If your opponent's Active Pokémon is a Team Magma Pokémon, this attack does 60 more damage." }
  ];
  public set: string = "DCR";
  public name: string = "Team Aqua's Sealeo";
  public fullName: string = "Team Aqua's Sealeo DCR 4";
