...
export class Butterfree_3 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      ...
      { name: "Whirlwind", cost: [], damage: "80", text: "Your opponent switches their Active Pokémon with 1 of their Benched Pokémon." }
  ];
