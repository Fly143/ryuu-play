...
export class BlastoiseEXXY30 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      ...
      { name: "Splash Bomb", cost: [], damage: "130", text: "Flip a coin. If tails, this Pokémon does 30 damage to itself." }
  ];
  public set: string = "PR-XY";
  public name: string = "Blastoise-EX";
  public fullName: string = "Blastoise-EX PR-XY XY30";
