...
export class EldegossV_5 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Float Up", cost: [], damage: "50", text: "You may shuffle this Pokémon and all cards attached to it into your deck." }
  ];
