...
export class Heatmor_26 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Searing Flame", cost: [], damage: "10", text: "Your opponent's Active Pokémon is now Burned." },
      { name: "Fire Claws", cost: [], damage: "50", text: "" }
  ];
