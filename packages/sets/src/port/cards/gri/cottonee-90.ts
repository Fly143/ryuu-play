...
export class Cottonee_902 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Continuous Tumble", cost: [], damage: "10×", text: "Flip a coin until you get tails. This attack does 10 damage for each heads." }
  ];
