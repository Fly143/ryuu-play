...
export class Vibrava_47 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      ...
      { name: "Quick Turn", cost: [], damage: "40×", text: "Flip 2 coins. This attack does 40 damage times the number of heads." }
  ];
  public set: string = "DR";
  public name: string = "Vibrava";
  public fullName: string = "Vibrava DR 47";
