...
export class Luxio_52 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Fasten Claws", cost: [], damage: "10+", text: "Flip a coin. If heads, this attack does 10 damage plus 30 more damage." },
  ...
  public fullName: string = "Luxio DP 52";
