...
export class Golurk_44 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Triple Smash", cost: [], damage: "10+", text: "Flip 3 coins. This attack does 60 more damage for each heads." },
      { name: "Golurk Hammer", cost: [], damage: "120", text: "" }
  ];
