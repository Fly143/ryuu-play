...
export class Shelgon_105 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Raging Blade", cost: [], damage: "30+", text: "If this Pokémon has any damage counters on it, this attack does 50 more damage." }
  ];
