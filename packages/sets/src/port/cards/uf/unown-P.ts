...
export class UnownP extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Hidden Power", cost: [], damage: "", text: "Put 1 damage counter on each of your opponent's Pokémon that already has damage counters on it." }
  ];
  public set: string = "UF";
  public name: string = "Unown";
  public fullName: string = "Unown UF P";
