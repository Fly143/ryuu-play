...
export class Hypno_60 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Meditate", cost: [], damage: "20+", text: "This attack does 10 more damage for each damage counter on your opponent's Active Pokémon." },
