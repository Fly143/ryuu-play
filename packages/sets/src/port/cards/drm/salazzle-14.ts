...
export class Salazzle_14 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Ring of Fire", cost: [], damage: "20", text: "Your opponent's Active Pokémon is now Burned. It can't retreat during your opponent's next turn." },
