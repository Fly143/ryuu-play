...
export class Virizion_17 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Giga Drain", cost: [], damage: "30", text: "Heal from this Pokémon the same amount of damage you did to the Defending Pokémon." },
