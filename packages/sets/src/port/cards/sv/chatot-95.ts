...
export class Chatot_95 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      ...
      { name: "Nosedive", cost: [], damage: "30", text: "Flip a coin. If tails, Chatot does 10 damage to itself." }
  ];
  public set: string = "SV";
  public name: string = "Chatot";
  public fullName: string = "Chatot SV 95";
