...
export class Persian_89 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Raid", cost: [], damage: "30+", text: "If this Pokémon evolved from Meowth during this turn, this attack does 30 more damage." },
