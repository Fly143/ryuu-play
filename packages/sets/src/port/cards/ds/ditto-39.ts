...
export class Ditto_39 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Thunderbolt", cost: [], damage: "40", text: "Discard all Energy cards attached to Ditto." }
  ];
  public set: string = "DS";
  public name: string = "Ditto";
  public fullName: string = "Ditto DS 39";
