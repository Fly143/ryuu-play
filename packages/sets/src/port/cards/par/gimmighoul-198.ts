...
export class Gimmighoul_198 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Continuous Coin Toss", cost: [], damage: "20×", text: "Flip a coin until you get tails. This attack does 20 damage for each heads." }
  ];
