...
export class Gurdurr_104 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      ...
      { name: "Superpower", cost: [], damage: "50+", text: "You may do 30 more damage. If you do, this Pokémon also does 30 damage to itself." }
  ];
