...
export class Cubone_105 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      ...
      { name: "Bonemerang", cost: [], damage: "20×", text: "Flip 2 coins. This attack does 20 damage for each heads." }
  ];
  public set: string = "CEC";
  public name: string = "Cubone";
  public fullName: string = "Cubone CEC 105";
