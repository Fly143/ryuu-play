...
export class Empoleon_29 extends PokemonCard {
  ...
  public powers: Power[] = [
      { name: "Diving Draw", powerType: PowerType.ABILITY, text: "Once during your turn (before your attack), you may discard 1 card from your hand. If you do, draw 2 cards.", useWhenInPlay: true }
  ];
  ...
  public fullName: string = "Empoleon DRX 29";
