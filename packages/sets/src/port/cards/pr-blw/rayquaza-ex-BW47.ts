...
export class RayquazaEXBW47 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      ...
      { name: "Dragon Burst", cost: [], damage: "60×", text: "Discard all basic Fire Energy or all basic Lightning Energy attached to this Pokémon. This attack does 60 damage times the number of Energy you discarded." }
  ];
  public set: string = "PR-BLW";
  public name: string = "Rayquaza-EX";
  public fullName: string = "Rayquaza-EX PR-BLW BW47";
