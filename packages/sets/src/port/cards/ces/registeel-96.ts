...
export class Registeel_96 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Silver Fist", cost: [], damage: "60+", text: "If your opponent's Active Pokémon has an Ability, this attack does 60 more damage." }
  ];
