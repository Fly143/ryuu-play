...
export class ChiYu_39 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      ...
      { name: "Ground Melter", cost: [], damage: "60+", text: "If a Stadium is in play, this attack does 60 more damage. Then, discard that Stadium." }
  ];
