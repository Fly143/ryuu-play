...
export class Bronzong_72 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      ...
      { name: "Tool Drop", cost: [], damage: "40×", text: "This attack does 40 damage for each Pokémon Tool attached to all Pokémon." }
  ];
