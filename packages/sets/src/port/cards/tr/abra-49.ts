...
export class Abra_49 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Vanish", cost: [], damage: "", text: "Shuffle Abra into your deck. (Discard all cards attached to Abra.)" },
      { name: "Psyshock", cost: [], damage: "10", text: "Flip a coin. If heads, the Defending Pokémon is now Paralyzed." }
  ];
  public set: string = "TR";
  public name: string = "Abra";
  public fullName: string = "Abra TR 49";
