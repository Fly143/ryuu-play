...
export class TeamAquaSElectrike_27 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      ...
      { name: "Plasma", cost: [], damage: "10", text: "Flip a coin. If heads, search your discard pile for a Lightning Energy card and attach it to Team Aqua's Electrike." }
  ];
  public set: string = "MA";
  public name: string = "Team Aqua's Electrike";
  public fullName: string = "Team Aqua's Electrike MA 27";
