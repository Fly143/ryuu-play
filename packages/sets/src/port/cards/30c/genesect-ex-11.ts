...
export class GenesectEX_112 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Megalo Cannon", cost: [], damage: "100", text: "Does 20 damage to 1 of your opponent's Benched Pokémon. (Don't apply Weakness and Resistance for Benched Pokémon.)" }
  ];
  public set: string = "30C";
  public name: string = "Genesect-EX";
  public fullName: string = "Genesect-EX 30C 11";
