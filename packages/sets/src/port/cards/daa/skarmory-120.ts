...
export class Skarmory_120 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Metal Arms", cost: [], damage: "10+", text: "If this Pokémon has a Pokémon Tool attached, this attack does 40 more damage." },
