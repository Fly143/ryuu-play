...
export class Lanturn_50 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      ...
      { name: "Aqua Spark", cost: [], damage: "60+", text: "If this Pokémon has any Water Energy attached to it, this attack does 60 more damage." }
  ];
