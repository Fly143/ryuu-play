...
export class Machoke_53 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Karate Chop", cost: [], damage: "40-", text: "Does 40 damage minus 10 damage for each damage counter on Machoke." },
      { name: "Seismic Toss", cost: [], damage: "60", text: "" }
  ];
  public set: string = "DP";
  public name: string = "Machoke";
  public fullName: string = "Machoke DP 53";
