...
export class Foongus_8 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Find a Friend", cost: [], damage: "", text: "Flip a coin. If heads, search your deck for a Pokémon, reveal it, and put it into your hand. Shuffle your deck afterward." },
      { name: "Rising Lunge", cost: [], damage: "10+", text: "Flip a coin. If heads, this attack does 20 more damage." }
  ];
  public set: string = "DEX";
  public name: string = "Foongus";
  public fullName: string = "Foongus DEX 8";
