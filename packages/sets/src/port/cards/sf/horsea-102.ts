...
export class Horsea_102 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      ...
      { name: "Reverse Thrust", cost: [], damage: "10", text: "Switch Horsea with 1 of your Benched Pokémon." }
  ];
  public set: string = "SF";
  public name: string = "Horsea";
  public fullName: string = "Horsea SF 102";
