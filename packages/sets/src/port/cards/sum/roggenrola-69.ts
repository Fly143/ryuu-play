...
export class Roggenrola_69 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Smack Down", cost: [], damage: "20+", text: "If your opponent's Active Pokémon has Fighting Resistance, this attack does 50 more damage." }
  ];
