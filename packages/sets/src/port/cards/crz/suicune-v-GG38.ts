...
export class SuicuneVGG38 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Blizzard Rondo", cost: [], damage: "20+", text: "This attack does 20 more damage for each Benched Pokémon (both yours and your opponent's)." }
  ];
  public set: string = "CRZ";
  public name: string = "Suicune V";
  public fullName: string = "Suicune V CRZ GG38";
  public text: string = "Suicune V";
