...
export class UnownK extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Hidden Power", cost: [], damage: "20", text: "You may discard any Stadium card in play." }
  ];
  public set: string = "UF";
  public name: string = "Unown";
  public fullName: string = "Unown UF K";
