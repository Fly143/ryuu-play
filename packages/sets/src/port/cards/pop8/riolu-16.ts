...
export class Riolu_16 extends PokemonCard {
  ...
  public powers: Power[] = [
      { name: "Inner Focus", powerType: PowerType.ABILITY, text: "Riolu can't be Paralyzed.", useWhenInPlay: true }
  ];
  ...
  public fullName: string = "Riolu POP8 16";
