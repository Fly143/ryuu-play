...
export class Houndour_55 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      ...
      { name: "Ambush", cost: [], damage: "20+", text: "Flip a coin. If heads, this attack does 10 more damage." }
  ];
  public set: string = "FFI";
  public name: string = "Houndour";
  public fullName: string = "Houndour FFI 55";
