...
export class DarkBlastoise_4 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Hydrocannon", cost: [], damage: "30+", text: "Does 30 damage plus 20 more damage for each Water Energy attached to Dark Blastoise but not used to pay for this attack's Energy cost. You can't add more than 40 damage in this way." },
  ...
  public fullName: string = "Dark Blastoise G2 4";
