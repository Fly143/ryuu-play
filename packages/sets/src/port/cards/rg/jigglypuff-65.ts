...
export class Jigglypuff_65 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      ...
      { name: "Quick Blow", cost: [], damage: "10+", text: "Flip a coin. If heads, this attack does 10 damage plus 20 more damage." }
  ];
  public set: string = "RG";
  public name: string = "Jigglypuff";
  public fullName: string = "Jigglypuff RG 65";
