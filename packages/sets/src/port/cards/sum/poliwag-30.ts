...
export class Poliwag_30 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      ...
      { name: "Hydro Pump", cost: [], damage: "30+", text: "This attack does 10 more damage times the amount of Water Energy attached to this Pokémon." }
  ];
