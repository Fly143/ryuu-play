...
export class Horsea_33 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Retaliate", cost: [], damage: "10×", text: "Flip a coin. If heads, this attack does 10 damage times the number of damage counters on Horsea." },
  ...
  public fullName: string = "Horsea DR 33";
