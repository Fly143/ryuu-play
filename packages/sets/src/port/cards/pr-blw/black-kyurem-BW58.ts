...
export class BlackKyuremBW58 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      ...
      { name: "Flash Freeze", cost: [], damage: "100", text: "Discard an Energy attached to this Pokémon." }
  ];
  public set: string = "PR-BLW";
  public name: string = "Black Kyurem";
  public fullName: string = "Black Kyurem PR-BLW BW58";
