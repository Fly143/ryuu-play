...
export class Maractus_2 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Mega Drain", cost: [], damage: "20", text: "Heal 20 damage from this Pokémon." },
  ...
  public fullName: string = "Maractus MCD11 2";
