...
export class Rotom_70 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Junk Hunt", cost: [], damage: "", text: "Put an Item card from your discard pile into your hand." },
  ...
  public fullName: string = "Rotom SVI 70";
