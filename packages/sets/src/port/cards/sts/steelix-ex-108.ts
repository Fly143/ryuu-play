...
export class SteelixEX_108 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Wild Edge", cost: [], damage: "80+", text: "You may do 50 more damage. If you do, this Pokémon does 20 damage to itself." },
