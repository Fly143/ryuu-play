...
export class Deoxys_22 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Swift", cost: [], damage: "30", text: "This attack's damage isn't affected by Weakness, Resistance, Poké-Power, Poké-Bodies, or any other effects on the Defending Pokémon." }
  ];
  public set: string = "EM";
  public name: string = "Deoxys";
  public fullName: string = "Deoxys EM 2";
