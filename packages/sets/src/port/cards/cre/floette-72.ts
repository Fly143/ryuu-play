...
export class Floette_72 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      ...
      { name: "Double Spin", cost: [], damage: "50×", text: "Flip 2 coins. This attack does 50 damage for each heads." }
  ];
  public set: string = "CRE";
  public name: string = "Floette";
  public fullName: string = "Floette CRE 72";
