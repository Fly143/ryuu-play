...
export class Gligar_46 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Rock Cannon", cost: [], damage: "20×", text: "Flip a coin until you get tails. This attack does 20 damage times the number of heads." }
  ];
