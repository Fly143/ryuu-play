...
export class GalarianStunfisk_125 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Grip and Squeeze", cost: [], damage: "90", text: "During your opponent's next turn, the Defending Pokémon can't retreat." }
  ];
