...
export class Clauncher_33 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Double Pincers", cost: [], damage: "10×", text: "Flip 2 coins. This attack does 10 damage times the number of heads." }
  ];
