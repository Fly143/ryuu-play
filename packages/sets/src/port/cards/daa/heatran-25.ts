...
export class Heatran_25 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      ...
      { name: "Raging Flare", cost: [], damage: "80+", text: "This attack does 10 more damage for each damage counter on this Pokémon." }
  ];
