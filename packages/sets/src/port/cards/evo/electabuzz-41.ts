...
export class Electabuzz_41 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      ...
      { name: "Thunder Punch", cost: [], damage: "30+", text: "Flip a coin. If heads, this attack does 10 more damage. If tails, this Pokémon does 10 damage to itself." }
  ];
  public set: string = "EVO";
  public name: string = "Electabuzz";
  public fullName: string = "Electabuzz EVO 41";
