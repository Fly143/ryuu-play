...
export class Duraludon_1292 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Raging Claws", cost: [], damage: "20+", text: "This attack does 10 more damage for each damage counter on this Pokémon." },
