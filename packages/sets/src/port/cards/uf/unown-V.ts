...
export class UnownV extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Hidden Power", cost: [], damage: "20+", text: "Does 20 damage plus 10 more damage for each Basic Pokémon and each Evolution card in your discard pile. You can't add more than 60 damage in this way." }
  ];
  public set: string = "UF";
  public name: string = "Unown";
  public fullName: string = "Unown UF V";
