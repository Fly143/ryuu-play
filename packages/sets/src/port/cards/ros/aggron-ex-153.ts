...
export class AggronEX_153 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Steel Headbutt", cost: [], damage: "50+", text: "Flip a coin. If heads, this attack does 30 more damage." },
  ...
  public fullName: string = "Aggron-EX ROS 153";
