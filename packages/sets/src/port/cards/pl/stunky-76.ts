...
export class Stunky_763 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Gnaw and Run", cost: [], damage: "10", text: "Switch Stunky with 1 of your Benched Pokémon." },
  ...
  public fullName: string = "Stunky PL 76";
