...
export class Delibird_39 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Snowy Present", cost: [], damage: "", text: "Draw a card for each Water Energy attached to all of your Pokémon." },
  ...
  public fullName: string = "Delibird HS 39";
