...
export class Darumaka_15 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Blaze Ball", cost: [], damage: "10+", text: "This attack does 20 more damage for each Fire Energy attached to this Pokémon." }
  ];
