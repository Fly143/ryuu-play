...
export class ChimcharDP02 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      ...
      { name: "Ember", cost: [], damage: "30", text: "Flip a coin. If tails, discard a Fire Energy attached to Chimchar." }
  ];
  public set: string = "PR-DPP";
  public name: string = "Chimchar";
  public fullName: string = "Chimchar PR-DPP DP02";
