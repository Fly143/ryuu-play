...
export class Jirachi_21 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "The Third Eye", cost: [], damage: "", text: "Discard an Energy card attached to Jirachi and draw 3 cards." },
  ...
  public fullName: string = "Jirachi PR-NP 21";
