...
export class Sigilyph_121 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      ...
      { name: "Telekinesis", cost: [], damage: "", text: "This attack does 70 damage to 1 of your opponent's Pokémon. This attack's damage isn't affected by Weakness or Resistance." }
  ];
  public set: string = "WHT";
  public name: string = "Sigilyph";
  public fullName: string = "Sigilyph WHT 121";
