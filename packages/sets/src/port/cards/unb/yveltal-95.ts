...
export class Yveltal_95 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Derail", cost: [], damage: "30", text: "Discard a Special Energy from your opponent's Active Pokémon." },
  ...
  public fullName: string = "Yveltal UNB 95";
