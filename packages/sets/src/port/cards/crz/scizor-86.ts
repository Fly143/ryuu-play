...
export class Scizor_86 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      ...
      { name: "Dangerous Claws", cost: [], damage: "80+", text: "If your opponent's Active Pokémon is a Basic Pokémon, this attack does 80 more damage." }
  ];
