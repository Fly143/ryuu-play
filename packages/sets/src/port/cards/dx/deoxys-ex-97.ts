...
export class DeoxysEx_97 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Energy Burst", cost: [], damage: "10+", text: "Does 10 damage plus 10 more damage for each Energy attached to Deoxys ex and the Defending Pokémon." }
  ];
  public set: string = "DX";
  public name: string = "Deoxys ex";
  public fullName: string = "Deoxys ex DX 97";
