...
export class Pancham_72 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Karate Chop", cost: [], damage: "60-", text: "This attack does 10 less damage for each damage counter on this Pokémon." }
  ];
