...
export class GenesectEX_120 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Rapid Blaster", cost: [], damage: "100+", text: "Discard as many Metal Energy attached to this Pokémon as you like. This attack does 20 more damage for each Metal Energy you discarded." }
  ];
  public set: string = "FAC";
  public name: string = "Genesect-EX";
  public fullName: string = "Genesect-EX FAC 120";
