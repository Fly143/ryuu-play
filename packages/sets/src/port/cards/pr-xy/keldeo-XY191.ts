...
export class KeldeoXY191 extends PokemonCard {
  ...
  public fullName: string = "Keldeo PR-XY XY191";
  ...
  public reduceEffect(store: StoreLike, state: State, effect: Effect): State {
    ...
    if (effect instanceof BetweenTurnsEffect) {
      return commonEffects.refreshPowerAura(this, store, state, effect.player, "plusPowerMarker:50");
    }
    return state;
  }
}
