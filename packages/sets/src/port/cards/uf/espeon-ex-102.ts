...
export class EspeonEx_102 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      ...
      { name: "Psyloop", cost: [], damage: "60+", text: "Does 60 damage plus 30 more damage for each Trainer card your opponent has in play." }
  ];
