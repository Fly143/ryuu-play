...
export class Swellow_104 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      ...
      { name: "Swallow Dive", cost: [], damage: "40+", text: "If this Pokémon used Agility during your last turn, this attack does 80 more damage." }
  ];
