...
export class UnownO extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Hidden Power", cost: [], damage: "20", text: "Return Unown and all Energy cards attached to it to your hand." }
  ];
  public set: string = "UF";
  public name: string = "Unown";
  public fullName: string = "Unown UF O";
