...
export class Purrloin_82 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Tail Trickery", cost: [], damage: "", text: "Flip a coin. If heads, the Defending Pokémon is now Confused." },
  ...
  public fullName: string = "Purrloin PLB 82";
