...
export class HoOhGX_21 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      ...
      { name: "Eternal Flame-GX", cost: [], damage: "", text: "Put 3 in any combination of Fire Pokémon-GX or Fire Pokémon-EX from your discard pile onto your Bench. (You can't use more than 1 GX attack in a game.)" }
  ];
  public set: string = "BUS";
  public name: string = "Ho-Oh-GX";
  public fullName: string = "Ho-Oh-GX BUS 21";
