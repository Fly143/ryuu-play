...
export class Pikachu_522 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Angry Bolt", cost: [], damage: "10+", text: "This attack does 10 more damage for each damage counter on this Pokémon." }
  ];
