...
export class Sandshrew_752 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      ...
      { name: "Sand Tomb", cost: [], damage: "20", text: "The Defending Pokémon can't retreat during your opponent's next turn." }
  ];
  public set: string = "BKP";
  public name: string = "Sandshrew";
  public fullName: string = "Sandshrew BKP 75";
