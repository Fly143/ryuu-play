...
export class Dedenne_88 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      ...
      { name: "Electrichain", cost: [], damage: "30+", text: "If you have any Lightning Pokémon on your Bench, this attack does 30 more damage." }
  ];
