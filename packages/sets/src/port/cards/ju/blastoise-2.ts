...
export class Blastoise_22 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Hydro Pump", cost: [], damage: "40+", text: "Does 40 damage plus 10 more damage for each Water Energy attached to Blastoise but not used to pay for this attack's Energy cost. You can't add more than 20 damage in this way." }
  ];
  public set: string = "JU";
  public name: string = "Blastoise";
  public fullName: string = "Blastoise JU 2";
