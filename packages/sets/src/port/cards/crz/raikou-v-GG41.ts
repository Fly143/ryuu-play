...
export class RaikouVGG41 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Lightning Rondo", cost: [], damage: "20+", text: "This attack does 20 more damage for each Benched Pokémon (both yours and your opponent's)." }
  ];
  public set: string = "CRZ";
  public name: string = "Raikou V";
  public fullName: string = "Raikou V CRZ GG41";
  public text: string = "Raikou V";
