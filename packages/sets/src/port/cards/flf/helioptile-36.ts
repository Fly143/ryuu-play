...
export class Helioptile_36 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      ...
      { name: "Destructive Beam", cost: [], damage: "", text: "Flip a coin. If heads, discard an Energy attached to your opponent's Active Pokémon." }
  ];
