...
export class Grovyle_4 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Poison Breath", cost: [], damage: "", text: "The Defending Pokémon is now Poisoned." },
  ...
  public fullName: string = "Grovyle PR-NP 4";
