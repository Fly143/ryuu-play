...
export class Deoxys_23 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Crystal Laser", cost: [], damage: "20", text: "During your next turn, Deoxys's attacks do 40 more damage to the Defending Pokémon (before applying Weakness and Resistance)." }
  ];
  public set: string = "POP4";
  public name: string = "Deoxys δ";
  public fullName: string = "Deoxys δ POP4 2";
