...
export class TapuLele_92 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Perplex", cost: [], damage: "20", text: "Your opponent's Active Pokémon is now Confused." },
  ...
  public fullName: string = "Tapu Lele SSP 92";
