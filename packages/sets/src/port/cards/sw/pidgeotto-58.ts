...
export class Pidgeotto_58 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      ...
      { name: "Quick Attack", cost: [], damage: "30+", text: "Flip a coin. If heads, this attack does 30 damage plus 30 more damage." }
  ];
