...
export class Dedenne_36 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      ...
      { name: "Spin Turn", cost: [], damage: "50", text: "Switch this Pokémon with 1 of your Benched Pokémon." }
  ];
  public set: string = "PAF";
  public name: string = "Dedenne";
  public fullName: string = "Dedenne PAF 36";
