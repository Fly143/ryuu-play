...
export class Basculin_24 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      ...
      { name: "Final Gambit", cost: [], damage: "80", text: "Flip 2 coins. If both of them are tails, this Pokémon does 80 damage to itself." }
  ];
