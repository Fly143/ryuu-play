...
export class JangmoO_98 extends PokemonCard {
  ...
  public powers: Power[] = [
      { name: "Bulletproof", powerType: PowerType.ABILITY, text: "This Pokémon takes 10 less damage from attacks (after applying Weakness and Resistance).", useWhenInPlay: true }
  ];
