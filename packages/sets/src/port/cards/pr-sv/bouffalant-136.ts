...
export class Bouffalant_136 extends PokemonCard {
  ...
  public fullName: string = "Bouffalant PR-SV 136";
  ...
  public reduceEffect(store: StoreLike, state: State, effect: Effect): State {
    ...
    if (effect instanceof BetweenTurnsEffect) {
      return commonEffects.refreshPowerAura(this, store, state, effect.player, "reduceDamageSelf:60");
    }
    return state;
  }
}
