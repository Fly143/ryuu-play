...
export class TyranitarXY130 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Dark Mountain", cost: [], damage: "150+", text: "Discard the top 2 cards of your deck. This attack does 50 more damage for each Supporter card discard in this way." }
  ];
  public set: string = "PR-XY";
  public name: string = "Tyranitar";
  public fullName: string = "Tyranitar PR-XY XY130";
