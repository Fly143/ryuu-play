...
export class Charjabug_51 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Shocking Jaws", cost: [], damage: "20", text: "Flip a coin. If heads, your opponent's Active Pokémon is now Paralyzed." },
