...
export class Whismur_135 extends PokemonCard {
  ...
  public attacks: Attack[] = [
      { name: "Continuous Tumble", cost: [], damage: "40×", text: "Flip a coin until you get tails. This attack does 40 damage for each heads." }
  ];
